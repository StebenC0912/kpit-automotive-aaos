package com.kpit.connectivity.base.manager;
...
/**
 * Base class for every SDK-side Manager in the Connectivity domain (e.g. {@code IviBluetoothManager}).
 *
 * <p>This is the ONLY surface HMI applications are allowed to link against for talking to a
 * Connectivity domain service. It hides the Binder plumbing (service lookup, death recovery,
 ...
 */
public abstract class BaseConnectivityManager<T extends IInterface> {

    private static final String TAG = "BaseConnectivityManager";
     ...
     */
    protected BaseConnectivityManager(String serviceName) {
